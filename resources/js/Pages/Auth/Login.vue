<template>
    ...
    <div class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto bg-white dark:bg-background-dark shadow-sm font-display" dir="rtl">
        <!-- Header Section -->
        <div class="@container">
